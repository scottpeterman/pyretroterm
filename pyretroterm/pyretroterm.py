#!/usr/bin/env python3
"""
pyRetroTerm - A PyQt6 Terminal Emulator
"""
import os
import sys
import socket
...
import click
from pyretroterm.helpers.settings import SettingsManager
from pyretroterm.helpers.credslib import SecureCredentials

from pyretroterm.widgets.setup import setup_menus
from pyretroterm.widgets.terminal_tabs import TerminalTabWidget
...
class pyRetroTermWindow(QMainWindow):
    ...
    def init_ui(self):
        self.setWindowTitle('pyRetroTerm')
